...
public:
    ...
    */
    ...
    void send_eagle_lanes_state_report(class GCS_MAVLINK &link) const;
...
private:
    ...
    AP_Float _windMax;              // upper bound on the horizontal wind state magnitude : m/s (negative = no bound)
