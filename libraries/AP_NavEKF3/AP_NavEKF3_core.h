...
public:
    ...
    */
    ...
    // Time of the last NE position reset that also re-seeded the position covariance, or 0 if
    ...
    uint32_t getLastPosCovarianceReset(void) const;
...
private:
    ...
    uint32_t lastPosCovReset_ms;    // System time of the last position reset that re-seeded P. Returned by getLastPosCovarianceReset
